...
const IndexPageTemplate = `
	...
	<body class="bg-gray-100 dark:bg-gray-900 transition-colors duration-200">
		...
		<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
			<h2 class="text-3xl font-extrabold text-gray-900 dark:text-white mb-4">Welcome to CodemaHub</h2>
			<p class="text-xl text-gray-600 dark:text-gray-300">Your hub for reusable code patterns.</p>
		</div>
		<script>
